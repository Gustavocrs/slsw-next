...
function transformLegacyData(data, scenarioId) {
			...
			return [
				...
				},
				{
					...
					values: [
						...
						{
							d: 10,
							value: "Cicatriz brilhante - Redução passiva de dano mágico",
						},
...
export default function AwakeningTableEditor({ data, onChange, scenarioId }) {
	const [newRuleName, setNewRuleName] = useState("");
	const [newRuleDice, setNewRuleDice] = useState(6);

	const rules = transformLegacyData(data, scenarioId);
