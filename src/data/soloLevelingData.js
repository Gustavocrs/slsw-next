/**
 * Script para popular o Firestore com dados do Solo Leveling
 * Execute no browser console ou como script standalone
 */

import { EDGES_SL } from "../data/edgesSL";
import { HINDRANCES_SL } from "../data/hindrancesSL";
import { manualSections } from "../data/manualSections";
import { POWERS_SL } from "../data/powersSL";
...
const soloLevelingScenario = {
	...
	edges: EDGES_SL.map((e) => ({
		name: e.name,
		description: e.description,
		rank: e.rank,
		source: "SL",
	})),
	hindrances: HINDRANCES_SL.map((h) => ({
		name: h.name,
