...
export const POWERS = {
  ...
  "Detectar/Ocultar Arcano": {
    ...
    rank: "Novato",
    description: "Percebe ou esconde a presença de magia e itens mágicos.",
  },
  Disfarce: {
    pp: "2",
    range: "Pessoal",
  ...
  "Elemental (Manipular Elementos)": {
    ...
    duration: "5 rodadas",
    rank: "Novato",
    description: "Controla pequenas quantidades de ar, terra, fogo ou água.",
  },
  Emaranhar: {
    pp: "2",
    range: "Astúcia",
  ...
  Proteção: {
    ...
    duration: "5 rodadas",
    rank: "Novato",
    description: "Protege contra perigos ambientais (fogo, frio, radiação).",
  },
  Raio: {
    pp: "1",
    range: "Astúcia x 2",
  ...
  Som: {
    ...
    duration: "Instantânea",
    rank: "Novato",
    description: "Cria ou abafa sons, ou causa dano sônico.",
  },
  Telecinesia: {
    pp: "5",
    range: "Astúcia x 2",
    duration: "5 rodadas",
    rank: "Experiente",
    description: "Move objetos ou criaturas com a mente.",
  },
  Teleporte: {
    pp: "2",
    range: "Astúcia x 2",
  ...
  Voo: {
    ...
    duration: "5 rodadas",
    rank: "Veterano",
    description: "Permite voar com Movimentação igual à atual.",
  },
  Zumbi: {
    pp: "3",
    range: "Astúcia",
    duration: "1 hora",
    rank: "Veterano",
    description: "Reanima cadáveres como mortos-vivos sob seu comando.",
  },
};
