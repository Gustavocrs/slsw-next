/**
 * Base de dados para o Gerador de Aventuras - Solo Leveling
...
export const adventureData = {
  themes: {
    "Caçada / Eliminação": {
      hooks: [
        ...
        "Um Portal Sombrio surgiu em uma velha estação de tratamento de água, contaminando o suprimento.",
        "Animais de uma floresta próxima começaram a fugir em massa devido a uma fenda recém-aberta.",
        "A Associação perdeu contato com a equipe de batedores enviada para um Portal Rank C.",
        "Uma criatura alada escapou de um Portal em um telhado e está aterrorizando os céus.",
        "Um Portal instável apareceu em um parque de diversões, mascarado pelas luzes e barulho.",
      ],
      objectives: [
        ...
        "Eliminar a matilha de bestas elementais antes que destruam a barreira de contenção.",
        "Destruir os três totens de energia que mantêm o Boss invulnerável.",
        "Sobreviver a ondas de inimigos até a porta do Boss se materializar.",
        "Abater os líderes de duas facções de monstros que guerreiam entre si.",
        "Encontrar e exterminar o 'Ninho' principal antes que os ovos eclodam.",
      ],
      twists: [
        ...
        "O Boss não é a criatura mais forte, mas sim o parasita que a controla.",
        "A Dungeon começa a colapsar assim que o Boss chega à metade da vida.",
        "As bestas eliminadas ressuscitam como mortos-vivos na segunda fase.",
        "O contratante na verdade quer capturar o Boss, alterando o acordo no meio da luta.",
        "Uma ilusão poderosa faz os membros do grupo verem uns aos outros como monstros.",
      ],
    },
    "Resgate / Escolta": {
      hooks: [
        ...
        "Um ônibus escolar colidiu de raspão com um Portal Invisível e foi parcialmente engolido.",
        "O herdeiro de uma família nobre medieval fugiu para dentro do Portal para provar seu valor.",
        "Uma equipe de resgate de emergência entrou para salvar feridos e ficou presa.",
        "A filha de um Caçador Lendário sumiu, e seu rastreador aponta para esta Fenda D.",
        "Cientistas tentando drenar Mana do Portal foram puxados para o interior.",
      ],
      objectives: [
        ...
        "Recuperar o alvo e encontrar a cura para o veneno fúngico que ele contraiu.",
        "Guiar o grupo de幸存者 em silêncio por uma área cheia de monstros cegos.",
        "Proteger a equipe de cientistas enquanto eles calibram o dispositivo de fechamento.",
        "Distrair as hordas principais enquanto os NPCs fogem por um atalho.",
        "Carregar um VIP que está em coma mágico sem sofrer ataques em área.",
      ],
      twists: [
        ...
        "O alvo do resgate está controlando os monstros através de um artefato.",
        "A vítima está infectada e prestes a se transformar em uma besta letal.",
        "Os 'sobreviventes' são metamorfos ilusórios imitando humanos.",
        "A celebridade contratante transmitiu a missão ao vivo e agora as ações têm peso público.",
        "O VIP se recusa a ser salvo até recuperar o item que perdeu na Dungeon.",
      ],
    },
    "Coleta / Exploração": {
      hooks: [
        ...
        "Um colecionador bilionário tem as chaves de um Portal selado há 10 anos e querabri-lo agora.",
        "O núcleo de energia de uma represa está reagindo à abertura de um Portal submerso.",
        "Um velho mapa pirata aponta para coordenadas dentro desta Fenda.",
        "A Associação precisa de amostras urgentes da água desta Dungeon para criar poções.",
        "Sensores detectaram uma jazida de Cristais Sombrios de alta pureza.",
        "O Portal abriu na base de um vulcão ativo, e a temperatura está subindo rapidamente.",
        "Uma relíquia de família de um Caçador foi roubada por um Golem e levada para lá.",
      ],
      objectives: [
        ...
        "Colher cinco amostras de flores bioluminescentes antes que murchem.",
        "Ler e copiar as inscrições dos três obeliscos sem ativar suas defesas.",
        "Encontrar o laboratório oculto e baixar os dados de pesquisa arcana.",
        "Minerar um cristal instável usando apenas ferramentas não-mágicas.",
        "Recuperar os restos mortais de uma expedição falha de anos atrás.",
      ],
      twists: [
        ...
        "O minério colhido emite radiação que atrai continuamente hordas.",
        "As ruínas contêm registros que provam corrupção dentro da Associação.",
        "O item recuperado ativa uma maldição de fadiga em quem o segura.",
        "A Dungeon inverte sua gravidade e layout quando o item principal é movido.",
        "O objetivo era uma isca; não há tesouro, apenas uma prisão antiga sendo aberta.",
      ],
    },
    "Sobrevivência / Anomalia": {
      hooks: [
        ...
        "O Portal está sugando o oxigênio da cidade vizinha, criando vácuo no ar.",
        "Ao entrar no Portal, as portas se fecham e os atributos dos Caçadores são trocados aleatoriamente.",
        "Uma névoa alucinógena está saindo do Portal, e o grupo precisa encontrar a fonte.",
        "O Portal é classificado como E, mas o medidor de Mana do grupo está dando erro.",
        "A fenda se abriu dentro de um laboratório de energia, e a radiação fundiu com a Mana.",
      ],
      objectives: [
        ...
        "Encontrar o núcleo da anomalia temporal e destruí-lo antes que desapareçam.",
        "Manter o portal estabilizado enquanto um especialista trabalha do lado de fora.",
        "Escapar do labirinto que muda de forma a cada 5 minutos.",
        "Enfrentar cópias sombrias do próprio grupo geradas pelo ambiente.",
        "Sobreviver à tempestade de Mana constante até que ela se dissipe naturalmente.",
      ],
      twists: [
        ...
        "As curas funcionam ao contrário: curam os monstros e dão dano nos jogadores.",
        "O grupo começa a perder memórias de curto prazo quanto mais tempo fica.",
        "A anomalia revela o futuro de um dos membros de forma trágica.",
        "O ambiente anula totalmente a magia, permitindo apenas danos físicos.",
        "Ao sair, a Associação diz que o grupo ficou sumido por 10 anos.",
      ],
    },
  },
  locations: [
    ...
    "Um cemitério submerso onde a água brilha com a luz de milhares de vaga-lumes arcanos.",
    "Um relógio monumental de engrenagens cósmicas girando pelo chão e teto.",
    "Os interiores apodrecidos da carcaça de um Leviatã colossal flutuando no vazio.",
    "Um labirinto de espinhos de roseiras sangrentas tão altas quanto prédios.",
    "Um arquipélago de ilhas flutuantes interligadas por correntes feitas de luz pura.",
  ],
  antagonists: [
    {
    ...
    },
    {
      ...
      description:
        "Usa táticas modernas, granadas e rifles encantandos contra o grupo.",
      stats:
  ...
  complications: [
    ...
    "Um membro do grupo tem alucinações vinculadas ao seu próprio Despertar.",
  ...
  connection_hints: [
    "A complicação principal é causada diretamente pela presença ou pelas ações do contratante (ou daquele que iniciou a missão).",
    "O ambiente e a localização da fenda fornecem a única vantagem real para cumprir o objetivo antes da reviravolta acontecer.",
    "O Twist (Reviravolta) na verdade facilita o objetivo inicial, mas impõe um terrível dilema moral aos jogadores.",
    "A criatura principal (ou alvo) está tentando ativamente fugir do verdadeiro perigo mencionado na reviravolta.",
    "O gancho (motivo de entrar) era uma mentira orquestrada para fazer o grupo sofrer o evento da reviravolta.",
    "Os perigos do ambiente afetam tanto os Caçadores quanto os monstros, forçando uma adaptação tática constante.",
    "O objetivo secundário torna-se subitamente mais importante que o primário para a sobrevivência a longo prazo.",
    "O antagonista (Chefe) conhece o motivo pelo qual o grupo está ali e usa isso contra eles emocionalmente.",
    "A missão é na verdade um 'teste' não-oficial arquitetado por uma Guilda superior ou por uma entidade misteriosa.",
    "A resolução do objetivo engatilha mecanicamente o Twist de forma inevitável; o grupo terá que lidar com as consequências imediatas.",
  ],
  twists: [
    "O Boss está usando o relógio de pulso moderno do filho do contratante; ele já foi morto.",
    "O contratante pagou para a equipe NÃO voltar, e plantou explosivos na saída do Portal.",
    ...
    "Ruínas da Dungeon revelam tecnologia da Terra de milhares de anos atrás.",
    "O Boss fala o idioma moderno perfeitamente antes de desmoronar em cinzas.",
    "A 'vítima' que deveriam rescatar é na verdade o necromante controlando o local.",
    "A fenda não era um Portal para Dungeon, mas uma rota para a base secreta de outra Guilda.",
    "O cristal principal não é Mana pura, mas um ovo prestes a eclodir no mundo real.",
    "Derrotar o Boss inicia uma contagem regressiva para auto-destruição termonuclear arcana.",
    "O verdadeiro Boss era o lacaio minúsculo que se escondia no teto o tempo todo.",
    ...
    "A pessoa salva recusa-se a voltar, pois a Dungeon a curou de uma doença terminal.",
    "A saída do Portal se move. O grupo sai em outro país ou continente.",
    "O grupo não foi o primeiro a chegar lá; há um esquadrão tático military Chacinado.",
    "A relíquia procurada reage apenas ao sangue de um dos membros específicos do grupo.",
    "O monstro não mata humanos, ele os congela em cristal para exibi-los como obras de arte.",
    "O Boss se rende, entrega a chave do Portal e se senta, esperando a morte pacificamente.",
    "Ao olhar reflexos na água da Dungeon, os personagens veem suas versões corrompidas.",
  ...
  clues: [
    "Teste de Perceber (-2) revela ranhuras no chão indicando o padrão da armadilha principal.",
    "Teste de Investigar descobre o diário de um caçador morto contendo a senha do enigma.",
    "Teste de Ocultismo (Magia) revela a natureza elemental do Boss antes de entrar na sala.",
    "Teste de Sobrevivência permite encontrar um atalho seguro burlando o primeiro encontro.",
    "Teste de Rastrear identifica os pontos fracos na armadura das criaturas do local.",
    "Teste de Ladinagem revela um fundo falso em um baú contendo poções de emergência.",
    "Teste de Consertar permite religar o gerador de luz do local, removendo a penalidade de escuridão.",
    "Teste de Curar em um NPC moribundo faz com que ele entregue a chave de atalho para a sala do chefe.",
  ],
  monsterLoot: [
    "Essência Menor (1d4)",
